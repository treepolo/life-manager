...
const styles = readFileSync(join(here, "../../src/app/pages/HomePage.css"), "utf8");
...
describe("首頁圖表順序", () => {
  ...
  it("人口比較卡的臺灣人單位維持單行", () => {
    expect(styles).toMatch(/\.percentile-card \.achievement-number-row b\s*\{[^}]*white-space:\s*nowrap;/s);
  });
});
