...
import { AsyncJobStatus, useAsyncJobs } from "@/app/components/AsyncJobStatus";
...
export function IntegrationsPage() {
  ...
  const asyncJobs = useAsyncJobs("PROVIDER_SYNC");
  ...
  const asyncJobItems = asyncJobs.data?.data ?? [];
